        ...
        <div className='md:max-w-[1000px] w-full md:mx-auto mt-3'>
            ...
            <div className='flex  border border-slate-300'>
                ...
                <div className='flex gap-[30px]  mt-[100px] flex-col border-r border-slate-800 '>
                    {/* {data.map(broker => {
                        return (<img src={broker.image} alt='' className='h-[80px] w-fit mx-auto rounded-[15px]' />)
                    })} */}
                    <img src={ig} alt='' className='border-t border-slate-700' />
                    <img src={zazo} alt='' />
                    <img src={brokers} alt='' />
                    <img src={cmc} alt='' />
                    <img src={tda} alt='' />
                    ...
                    <table className=' mt-[25px]  border-slate-700'>
                        ...
                        <thead className='border-b  border-slate-700' >
                            <tr className='mb-7 my-[20px] p-2'>
                                ...
                                <td className='mx-4 text-[16px] px-6 text-center font-bold' >Mobile trading</td>
                                ...
                                return (
                                    <tr className='my-1  mt-[10px] '>
                                        ...
                                        <td className='mx-9 text-[18px] px-1'>
                                            <a data-dd="1" href="/">
                                                <img alt="IG logo" loading="lazy" src={broker.star.or} title="IG logo" className=' mx-1  flex justify-center w-[100px] h-[90px] ' /></a>

                                        </td>

                                        <td className='mx-9 text-[18px] px-1 mt-9 '>
                                            <a data-dd="1" href="/">
                                                <img alt="IG logo" loading="lazy" src={broker.star.ooi} title="IG logo" className=' mx-5  flex justify-center w-[100px] h-[90px] ' /></a>

                                        </td>

                                        <td className='mx-9 text-[18px] px-1 mt-9 '>
                                            <a data-dd="1" href="/">
                                                <img alt="IG logo" loading="lazy" src={broker.star.cf} title="IG logo" className=' mx-3  flex justify-center w-[100px] h-[90px] ' /></a>

                                        </td>

                                        <td className='mx-9 text-[18px] px-1 mt-9 '>
                                            <a data-dd="1" href="/">
                                                <img alt="IG logo" loading="lazy" src={broker.star.pt} title="IG logo" className=' mx-2  flex justify-center w-[100px] h-[90px] ' /></a>

                                        </td>

                                        <td className='mx-9 text-[18px] px-1 mt-9 '>
                                            <a data-dd="1" href="/">
                                                <img alt="IG logo" loading="lazy" src={broker.star.r} title="IG logo" className=' mx-3  flex justify-center w-[100px] h-[90px] ' /></a>

                                        </td>

                                        <td className='mx-9 text-[18px] px-1 mt-9 '>
                                            <a data-dd="1" href="/">
                                                <img alt="IG logo" loading="lazy" src={broker.star.e} title="IG logo" className='mx-4 flex justify-center w-[100px] h-[90px] ' /></a>

                                        </td>

                                        <td className='mx-9 text-[18px] px-1 mt-9 '>
                                            <a data-dd="1" href="/">
                                                <img alt="IG logo" loading="lazy" src={broker.star.mt} title="IG logo" className='mx-4 flex justify-center w-[100px] h-[90px] ' /></a>

                                        </td>

                                        <td className='mx-9 text-[18px] text-center px-1 mt-9 '>{broker.ts}
                                        </td>

                                        <td className='mx-9 text-[18px] px-1 mt-9 text-center '>
