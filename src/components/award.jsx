    ...
    return (
        <div className='w-full p-7'>
            ...
            <div className='md:max-w-[1000px]  w-full  md:mx-auto mt-7'>
                ...
                <div className='mt-4'>
                    <h3 className='md:text-[30px] text-[25px] font-semi-bold md:mt-6 mt-2 px-4'>Runner-Up: <a href="https://clicks.pipaffiliates.com/c?c=632795&1=en&p=1" className="">XM</a></h3>
